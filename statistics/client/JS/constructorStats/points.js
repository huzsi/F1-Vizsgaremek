...
async function fetchdataPoints(tableId) {
    try {
      const response = await fetch("/api/points"); // Az API végpont
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const button = document.getElementById("loadPoints");
    button.addEventListener("click", () => {
      fetchdataPoints("dataTable");
