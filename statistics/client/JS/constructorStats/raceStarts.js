...
async function fetchDataRaceStarts(tableId) {
    try {
      const response = await fetch("/api/raceStarts"); // Az API végpont
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const button = document.getElementById("loadRaceStarts");
    button.addEventListener("click", () => {
      fetchDataRaceStarts("dataTable");
