            ...
            fetch('/race-schedule')
                ...
                .then(scheduleData => {
                    ...
                    if (nextRace) {
                        ...
                        const events = [
                            { event: 'Event 1', date: nextRace.event1 },
                            { event: 'Event 2', date: nextRace.event2 },
                            { event: 'Event 3', date: nextRace.event3 },
                            { event: 'Event 4', date: nextRace.event4 },
                            { event: 'Event 5', date: nextRace.event5 }
                        ];
