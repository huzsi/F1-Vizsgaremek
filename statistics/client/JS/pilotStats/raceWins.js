...
async function fetchDataRaceWins(tableId) {
    try {
      const response = await fetch("/api/raceWins"); // Az API végpont
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const button = document.getElementById("loadRaceWins");
    button.addEventListener("click", () => {
      fetchDataRaceWins("dataTable");
